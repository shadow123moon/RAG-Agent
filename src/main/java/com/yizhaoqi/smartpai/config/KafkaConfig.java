...
public class KafkaConfig {
    ...
    @Value("${spring.kafka.topic.rag-ingest:rag-ingest-topic}")
    private String ragIngestTopic;

    @Value("${spring.kafka.topic.rag-dlt:rag-ingest-dlt}")
    private String ragIngestDltTopic;
    ...
    public String getRagIngestTopic() {
        return ragIngestTopic;
    }
    ...
    @Bean
    public NewTopic ragIngestNewTopic() {
        return TopicBuilder.name(ragIngestTopic)
                .partitions(topicPartitions)
                .replicas(topicReplicationFactor)
                .build();
    }
    ...
    @Bean
    public NewTopic ragIngestDltNewTopic() {
        return TopicBuilder.name(ragIngestDltTopic)
                .partitions(topicPartitions)
                .replicas(topicReplicationFactor)
                .build();
    }
